    ...
    <div class="item">
        <div class="p-5 bg-white">
            <div class="home-section-column">
                ...
                <sub class="text-right pb-5">Last updated May 20, 2018</sub>

                <h3 class="w-100 py-3">AGREEMENT TO TERMS</h3>
                <p class="w-100">
                    These Terms of Use constitute a legally binding agreement made between you, whether
                    personally or on behalf of an entity (“you”) and Raze Technologies Inc. (“we,” “us” or “our”),
                    concerning your access to and use of the www.razeline.com website as well as any other media form,
                ...
                <h3 class="w-100 py-3">INTELLECTUAL PROPERTY RIGHTS</h3>
                <p class="w-100">
                ...
                <h3 class="w-100 py-3">USER REPRESENTATIONS</h3>
                ...
                <h3 class="w-100 py-3">PROHIBITED ACTIVITIES</h3>
                ...
                <h3 class="w-100 py-3">USER GENERATED CONTRIBUTIONS</h3>
                ...
                <ol>
                    ...
                    <li>Your Contributions do not advocate the violent overthrow of any government or incite, encourage,
                        or threaten physical harm against another.
                    </li>
                    <li>Your Contributions do not violate any applicable law, regulation, or rule.</li>
                    <li>Your Contributions do not violate the privacy or publicity rights of any third party.</li>
                    <li>Your Contributions do not contain any material that solicits personal information from anyone
                ...
                <h3 class="w-100 py-3">CONTRIBUTION LICENSE</h3>
                ...
                <h3 class="w-100 py-3">GUIDELINES FOR REVIEWS</h3>
                ...
                <h3 class="w-100 py-3">SOCIAL MEDIA</h3>
                ...
                <h3 class="w-100 py-3">SUBMISSIONS</h3>
                <p class="w-100">
                ...
                <h3 class="w-100 py-3">THIRD-PARTY WEBSITES AND CONTENT</h3>
                ...
                <h3 class="w-100 py-3">SITE MANAGEMENT</h3>
                ...
                <h3 class="w-100 py-3">MODIFICATIONS AND INTERRUPTIONS</h3>
                <p class="w-100">We reserve the right to change, modify, or remove the contents of the Site at any time
                    or for any reason at our sole discretion without notice. However, we have no obligation to update
                    ...
                    modification, price change, suspension, or discontinuance of the Site. </p>
                <p class="w-100">We cannot guarantee the Site will be available at all times. We may experience
                ...
                <h3 class="w-100 py-3">GOVERNING LAW</h3>
                <p class="w-100">These Terms of Use and your use of the Site are governed by and construed in accordance
                    with the laws of the State of Michigan applicable to agreements made and to be entirely performed
                    within the the State of Michigan, without regard to its conflict of law principles. </p>


                <h3 class="w-100 py-3">DISPUTE RESOLUTION</h3>

                <h4 class="w-100 py-2">Informal Negotiations</h4>

                <p class="w-100">To expedite resolution and control the cost of any dispute, controversy, or claim
                    related to these Terms of Use (each a "Dispute" and collectively, the “Disputes”) brought by either
                    ...
                    written notice from one Party to the other Party.</p>

                <h4 class="w-100 py-2">Binding Arbitration</h4>
                <p class="w-100">If the Parties are unable to resolve a Dispute through informal negotiations, the
                    Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by
                    binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN
                    COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial
                    ...
                    applicable AAA rules or applicable law, the arbitration will take place in United States County, MI.
                ...
                <p class="w-100">If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute
                    shall be commenced or prosecuted in the state and federal courts located in United States County,
                    MI, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and
                    ...
                    the the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use.
                </p>

                <p class="w-100">In no event shall any Dispute brought by either Party related in any way to the Site be
                ...
                <h4 class="w-100 py-2">Restrictions</h4>
                <p class="w-100">
                ...
                <h4 class="w-100 py-2">Exceptions to Informal Negotiations and Arbitration</h4>
                ...
                <h3 class="w-100 py-3">CORRECTIONS</h3>

                <p class="w-100">There may be information on the Site that contains typographical errors, inaccuracies,
                ...
                <h3 class="w-100 py-3">DISCLAIMER</h3>
                <p class="w-100">THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE
                    SITE AND OUR SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM
                    ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE SITE AND YOUR USE THEREOF, INCLUDING,
                ...
                <h3 class="w-100 py-3">LIMITATIONS OF LIABILITY</h3>
                ...
                <p class="w-100">
                    ...
                    OF THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING
                    ...
                    YOU TO US DURING THE ONE (1) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN STATE LAWS
                ...
                <p class="w-100">
                    ...
                    made by any third party due to or arising out of: (1) your Contributions; (2) use of the Site; (3)
                    breach of these Terms of Use; (4) any breach of your representations and warranties set forth in
                    these Terms of Use; (5) your violation of the rights of a third party, including but not limited to
                ...
                <h3 class="w-100 py-3">USER DATA</h3>
                <p class="w-100">We will maintain certain data that you transmit to the Site for the purpose of managing
                    the performance of the Site, as well as data relating to your use of the Site. Although we perform
                ...
                <h3 class="w-100 py-3">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
                <p class="w-100">Visiting the Site, sending us emails, and completing online forms constitute electronic
                ...
                <h3 class="w-100 py-3">CALIFORNIA USERS AND RESIDENTS</h3>
                <p class="w-100">
                ...
                <h3 class="w-100 py-3">MISCELLANEOUS</h3>
                <p class="w-100">These Terms of Use and any policies or operating rules posted by us on the Site or in
                    ...
                    all defenses you may have based on the electronic form of these Terms of Use and the lack of signing
                    by the parties hereto to execute these Terms of Use.</p>


                <h3 class="w-100 py-3">CONTACT US</h3>
                <p class="w-100">In order to resolve a complaint regarding the Site or to receive further information
                    regarding use of the Site, please contact us at: </p>

                <p class="w-100 text-primary">Raze Technologies Inc.</p>
                <p class="w-100 text-primary">4860 Washtenaw Ave, Ann Arbor, MI 48108</p>
                <p class="w-100 text-primary">Ann Arbor, MI 48108</p>
                <p class="w-100 text-primary">United States</p>
                <p class="w-100 text-primary">Phone:(734) 407 - 9626</p>
                <p class="w-100 text-primary">accounts@razeline.com</p>
            </div>
        </div>
    </div>
@endsection